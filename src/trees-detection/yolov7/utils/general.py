...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    max_det = 300000000  # maximum number of detections per image
    max_nms = 300000000  # maximum number of boxes into torchvision.ops.nms()
    time_limit = 1200.0  # seconds to quit after
